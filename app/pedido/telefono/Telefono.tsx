    ...
    <div className="mt-4">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="w-full rounded-xl bg-white/10 border border-white/20 pl-9 pr-3 py-3 text-lg text-white placeholder-white/60 outline-none focus:ring-2 focus:ring-white/30"
        />
      </div>
      {cliente && (
